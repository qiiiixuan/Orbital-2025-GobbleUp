...
#ifndef MY_FLUTTER_GOBBLEUP_SWIFT_H
#define MY_FLUTTER_GOBBLEUP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="my_flutter_gobbleup",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19my_flutter_gobbleup11AppDelegate")
...
SWIFT_CLASS("_TtC19my_flutter_gobbleup17MainFlutterWindow")
